...
#define PRODUCT_WIFI_SSID             "WiFi_Lamp"         // Name of the device, to be displayed during configuration. Should match export request info.
#define BOARD_CONFIG_AP_URL           "wifi-lamp.cc"      // Config page will be available in a browser at 'http://our-product.cc/'
